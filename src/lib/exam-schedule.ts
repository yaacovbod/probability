...
export const EXAM_SCHEDULE: ExamEntry[] = [
  ...
  { subject: 'major', label: 'ניהול עסקי',  date: new Date('2026-06-04'), title: 'בגרות בניהול עסקי',  round: 'א', bagrutField: 'major_other', schoolMajorKey: 'ניהול עסקי' },
  { subject: 'major', label: 'מוטל',        date: new Date('2026-06-15'), title: 'בגרות במוטל',        round: 'א', bagrutField: 'major_motal', schoolMajorKey: 'מוטל' },
  { subject: 'major', label: 'פיזיקה',      date: new Date('2026-06-15'), title: 'בגרות בפיזיקה',      round: 'א', bagrutField: 'major_other', schoolMajorKey: 'פיזיקה' },
  { subject: 'literature', label: 'ספרות',        date: new Date('2026-06-17'), title: 'בגרות בספרות',              round: 'א' },
  { subject: 'major', label: 'פסיכולוגיה',  date: new Date('2026-06-22'), title: 'בגרות בפסיכולוגיה',  round: 'א', bagrutField: 'major_other', schoolMajorKey: 'פסיכולוגיה' },
  { subject: 'major', label: 'מידע ונתונים', date: new Date('2026-06-25'), title: 'בגרות במידע ונתונים', round: 'א', bagrutField: 'major_other', schoolMajorKey: 'מידע ונתונים' },
  { subject: 'major', label: 'מדעי המחשב',  date: new Date('2026-06-25'), title: 'בגרות במדעי המחשב',  round: 'א', bagrutField: 'major_other', schoolMajorKey: 'מדעי המחשב' },
